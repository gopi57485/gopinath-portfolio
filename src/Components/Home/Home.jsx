            ...
            <div className="space-y-6">
              ...
              <div className="space-y-3">
                ...
                <p className="text-lg text-neutral-400 max-w-lg leading-relaxed">
                  Frontend developer with one year of React experience, building responsive, scalable web applications through real-world projects, focused on clean code and modern user-centered design.
                </p>
